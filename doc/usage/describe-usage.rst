...
Set it to ``True`` if you want to be sure of the integrity of the result. Otherwise, setting it to ``False`` will increase the availability and still return you the result of the ``describe`` even in case of a momentary problem with a dataset or product. 
