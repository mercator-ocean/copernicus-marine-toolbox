...
def open_dataset(
    ...
    chunk_size_limit : int, default 100
        Limit the size of the chunks in the dask array. Default is set to 0 (and uses the dataset chunks). Positive integer values are accepted. This is an experimental feature.
