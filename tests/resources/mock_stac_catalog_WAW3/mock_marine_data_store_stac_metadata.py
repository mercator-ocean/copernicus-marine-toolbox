...
from tests.resources.mock_stac_catalog_WAW3.mock_dataset_irrelevant import (
    MOCK_IRRELEVANT_DATASET,
)
...
from tests.resources.mock_stac_catalog_WAW3.mock_dataset_with_errors import (
...
from tests.resources.mock_stac_catalog_WAW3.mock_product_with_errors import (
...
def mocked_stac_requests_get(*args, **kwargs):
    ...
    if args[0] == CATALOG_URLS[1]:
        ...
        args[0] == f"{BASE_URL_WAW3}PRODUCT_W_ERRORS/"
        f"irrelevant_dataset_202012/"
        f"dataset.stac.json"
    ):
        return MockResponse(MOCK_IRRELEVANT_DATASET, 200)
    elif (
